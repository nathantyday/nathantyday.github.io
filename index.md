...
{% include button.html text="Repo" icon="github" link="https://github.com/nathantyday" color="#ba03d6" %} {% include button.html text="Tweet it" icon="linkedin" link="https://www.linkedin.com/in/nathantyday" color="#0d94e7" %} 
